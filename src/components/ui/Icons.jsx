...
// Added UploadCloud icon
export const UploadCloud = ({ className = "w-4 h-4" }) => (
  <svg
    viewBox="0 0 24 24"
    className={className}
    fill="none"
...
export const LayoutDashboard = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const CreditCard = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const LogOut = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const MoreHorizontal = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const Calendar = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
// --- Added the missing icons for the new transfer functionality ---

export const Banknote = ({ className = "w-4 h-4" }) => (
  <svg
    version="1.0"
    className={className}
    id="Layer_1"
...
export const Bitcoin = ({ className = "w-4 h-4" }) => (
  <svg
    fill="#000000"
    className={className}
    version="1.1"
...
export const Ethereum = ({ className = "w-4 h-4" }) => (
  <svg
    fill="#000000"
    viewBox="0 0 32 32"
    xmlns="http://www.w3.org/2000/svg"
...
export const Shield = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const MessageCircle = ({ className = "w-4 h-4" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
// If adding to your existing Icons.jsx file, include these:
...
export const File = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const Image = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const Lock = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
...
// Add this to your components/ui/Icons.jsx file
...
export const Usdt = ({ className = "w-4 h-4" }) => (
  <svg
  className={className}
    version="1.1"
    id="Layer_1"
...
export const Building = ({ className = "w-6 h-6" }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    className={className} 
    fill="none" 
...
// Optional: You might also want these additional useful icons
...
// Add this to your existing Icon.jsx
...
export const Camera = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
...
export const Upload = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
